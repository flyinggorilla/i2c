...
class StUsb4500 {
  ...
  */
  esp_err_t Init(uint8_t deviceAddress = 0x28, i2c_port_num_t i2cPort = I2C_NUM_0);
  ...
  */
  ...
  //I-squared-C Class
  i2c_port_num_t mI2cPort; //The generic connection to user's chosen I2C hardware
  //Variables
