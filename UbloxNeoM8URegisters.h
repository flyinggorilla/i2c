#ifndef _UBLOX_REGISTERS_H_
#define _UBLOX_REGISTERS_H_
...
const uint8_t UBX_NAV_SOL = 0x06;		//Positioning Solution Information
...
private:
	...
	//Init the packet structures and init them with pointers to the mUbxPayloadAck, payloadCfg and payloadBuf arrays
	ubxPacket packetAck = {0, 0, 0, 0, 0, mUbxPayloadAck, 0, 0, SFE_UBLOX_PACKET_VALIDITY_NOT_DEFINED, SFE_UBLOX_PACKET_VALIDITY_NOT_DEFINED};
